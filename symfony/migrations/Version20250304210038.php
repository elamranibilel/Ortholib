 ...
 */
final class Version20250304210038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD user_id INT NOT NULL, DROP orthophoniste_id, DROP patient_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD patient_id INT NOT NULL, CHANGE user_id orthophoniste_id INT NOT NULL');
