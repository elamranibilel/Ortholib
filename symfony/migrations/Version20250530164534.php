 ...
 */
final class Version20250530164534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE orthophoniste (id INT NOT NULL, cabinet_id INT NOT NULL, specialisation_id INT NOT NULL, nombre_heure_travail INT DEFAULT NULL, INDEX IDX_4C2CDD16D351EC (cabinet_id), INDEX IDX_4C2CDD165627D44C (specialisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE patient (id INT NOT NULL, choix_ortho_id INT DEFAULT NULL, specialisation_id INT NOT NULL, niveau_langue VARCHAR(255) NOT NULL, difficulte_test VARCHAR(255) NOT NULL, niveau_apprentissage VARCHAR(255) NOT NULL, deficient VARCHAR(255) NOT NULL, difficulte_rencontrees JSON NOT NULL, is_confirmed TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_1ADAD7EBFD553130 (choix_ortho_id), INDEX IDX_1ADAD7EB5627D44C (specialisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE specialisation (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
